...
We believe that social choice is a more flexible and realistic framework for representing fairness-aware issues in machine learning than the optimization frameworks typically employed. Social choice is inherently multi-agent, and therefore, the idea of the integration of multiple fairness concerns naturally emerges, rather than being a complex add-on. Importantly for recommendation problems, social choice naturally allows for heterogeneity and hence personalization across decision instances since a user is just another agent with preferences over the outcome. 

Finally, fairness is inherently a social and political construct, and a social choice formalization allows the preferences of different actors to be foregrounded, rather than relegated to the black box of machine learning optimization. The study of fairness has a long history in the social choice literature \cite{Young:Equity,Zwicker:Voting}.
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{1})~Fairness-Aware Recommendation}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{2})~Computational Social Choice for Fair Recommendations}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{1})~Recommendation Systems with Protected Values}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{2})~Re-Ranking Functions}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{3})~Metrics for Fair Recommendation}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{4})~User Preferences for Fairness}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{5})~Overall Framework}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{1})~Baselines}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{2})~Dynamic Lottery}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{3})~Allocation Lottery}
\vspace{0.25cm}
...
\vspace{0.25cm}
\noindent \textbf{(\romannum{1})~Experiments}
\vspace{0.25cm}
