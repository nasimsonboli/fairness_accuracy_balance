...
\label{sec:fair_ml}
    ...
    \subsection{Individual \& Group fairness}
        ...
        \textbf{(\romannum{1})~Individual fairness} is concerned with the similar treatment of similar users. This normative principle requires that like cases should be treated alike \cite{binns2020conflict} which is a fairness notion that goes back to Aristotle.
    ...
    \subsection{Sources of unfairness}
        ...
        \textbf{(\romannum{2})~Data} is another source of bias. The data can get biased during the data collection process. In some cases, some people are more likely to respond to surveys or volunteer information. This type of bias is know as response or submission bias. 
    ...
    % \todo[inline]{missing - maybe having a common section for both ML and recsys?!}
