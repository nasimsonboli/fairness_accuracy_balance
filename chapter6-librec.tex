...
To address these issues and based on our internal research needs we created \libauto{}, a Python wrapper for LibRec that is an existing standard Java-based library for recommender systems. In this chapter, we describe the enhancements we made to LibRec.\todo[inline]{too modest from we describe...} These enhancements include metrics for various classes of fairness definitions, extension of the experimental model to support result re-ranking and a library of associated re-ranking algorithms, and additional support for experiment automation and reporting, capability of parallelization, optimization, and etc.
...
\begin{figure}[ht!]
    \centering
    \include{figs/chapter6-librecauto/config_xml}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.6\linewidth]{figs/chapter6-librecauto/slack-post.png}
